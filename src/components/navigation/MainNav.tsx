  ...
  return <nav className="hidden md:flex items-center space-x-8">
      <NavigationMenu>
        <NavigationMenuList>
          ...
          <NavigationMenuItem>
            <Link to="/advertise" className="inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-foreground hover:bg-muted transition-colors">
              List Your Ranch
            </Link>
          </NavigationMenuItem>
        </NavigationMenuList>
